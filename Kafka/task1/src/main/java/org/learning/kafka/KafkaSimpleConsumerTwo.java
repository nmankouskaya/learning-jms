...
automatically now.
 */
public class KafkaSimpleConsumerTwo {
    ...
    public static void main(String[] args) {
        ...
        simpleConsumer.assign(Arrays.asList(new TopicPartition(PARSE_TRANSPORT_METADATA, 1)));
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> message : messages) {
                ...
                System.out.println("Consumer 2: New message received! For car id " +
